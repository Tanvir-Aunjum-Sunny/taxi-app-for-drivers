...
public class MessageFormatCommand implements FormatCommandInterface {
	...
	/**
	 * @see com.google.code.microlog4android.format.command.FormatCommandInterface#execute(String, String, long, com.google.code.microlog4android.Level, Object, Throwable)
	 */
